...
def hotword():
    ACCESS_KEY = "w5Le/uh5RqXD9iSVbpcvr6Va4lW1V9ZSqkj4Nysu1Ow7U9rESJPtaQ=="  # Your actual access key
    ...
    try:
        # Create porcupine with pre-trained keywords and your access key
        ...
        while True:
            ...
            if keyword_index >= 0:
                ...
                # Press Windows+J shortcut
                pyautogui.keyDown("win")
                pyautogui.press("j")
                time.sleep(2)  # Hold time if needed
                pyautogui.keyUp("win")
